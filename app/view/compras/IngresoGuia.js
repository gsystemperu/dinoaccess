Ext.define('dinoaccess.view.compras.IngresoGuia', {
  ...
  initComponent: function () {
    var storeOrdenCompraConfirmdaDet = Ext.create('dinoaccess.store.TmpOrdenCompraConfirmadas');
  ...
  getDatosDelProveedor: function () {
    return obj = {
      ...
      url: dinoaccess.util.Rutas.guiaProveedorGuardar,
      layout: 'hbox',
      padding: 5,
      bodyPadding: 5,
      defaults: {
      ...
      items: [{
        ...
        {
          fieldLabel: '<b>Guia del Proveedor</b>',
          name: 'serieGuia',
          flex: 1.5,
          allowBlank: false
        }, {
