Ext.define('dinoaccess.view.compras.AccionesGuia', {
    ...
    {   me = this;
        if(record){
          me.lookupReference('dgvOrdenCompraConfirDetalle').mask('..cargando');
           ...
           Ext.Ajax.request({
               url : dinoaccess.util.Rutas.OrdenCompraConfirmadaDetalle,
               params:{
                 id :  record.get('id')
               },
               success:function(response){
                  _data = dinoaccess.util.Util.decodeJSON(response.responseText);
     ...
     ********************************************/
     ...
     onClickEliminarGuiaEntrada:function(btn){
       ...
       if(__record){
           Ext.Ajax.request({
               url : dinoaccess.util.Rutas.ordenCompraAnularConfirmado,
               params:{
                 id : __record.get('id')
               },
               success:function(response){
