Ext.define('dinoaccess.view.ventas.AccionesPagosAcuentaPdv', {
    ...
    onClickGuardarPagoAcuenta:function(btn){
      ...
      if(__store){
        ...
        Ext.Ajax.request({
            url :dinoaccess.util.Rutas.facturacionAgregarPagosAcuenta,
            params:{
            ...
            success:function(response){
                  ...
                  if(__data.error!=0){
                    dinoaccess.util.Util.showToast('Registrado');
                    __view.close();
