Ext.define('dinoaccess.view.puntoventa.PagosAcuentaPdv', {
    ...
    requires   : [
        ...
        'dinoaccess.util.*',
        'Ext.grid.*',
        'dinoaccess.view.ventas.AccionesPagosAcuentaPdv'
    ],
    config : {
        nombre : '',
        monto  : 0,
   ...
   controller:'acciones-pagosacuentapdv',
    ...
    {
        me = this;
        __store = Ext.create('dinoaccess.store.PagosAcuenta');
        ...
        Ext.Ajax.request({
              url : dinoaccess.util.Rutas.facturacionBuscarPagosAcuenta,
              params:{
