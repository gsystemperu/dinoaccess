...
Ext.define('dinoaccess.view.conf.AccionesRegConfig', {
    ...
    onClickEliminarBanco:function(btn){
        me = this;
        Ext.Ajax.request({
                url: dinoaccess.util.Rutas.bancoEliminar,
    ...
    onSelectedCategoria : function( grid, record, index, eOpts ) {this.lookupReference('frmCategoria').loadRecord(record)},
     ...
     onClickEliminarCategoria:function(btn){
        me = this;
        Ext.Ajax.request({
                url: dinoaccess.util.Rutas.categoriaEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarColor:function(btn){
         me = this;
        Ext.Ajax.request({
                url: dinoaccess.util.Rutas.colorEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarMedida:function(btn){
         me = this;
        Ext.Ajax.request({
                url: dinoaccess.util.Rutas.medidaEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarUnidadMedida:function(btn){
          ...
          me = this;
        Ext.Ajax.request({
                url: dinoaccess.util.Rutas.unidadMedidaEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarTipoProducto:function(btn){
          me = this;
        Ext.Ajax.request({
                url: dinoaccess.util.Rutas.tipoProductoEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarPresentacion:function(button){
      var rec = button.getWidgetRecord();
          if (rec) {
             Ext.Ajax.request({
                 url :dinoaccess.util.Rutas.presentacionEliminar,
                 params:{
    ...
    onClickEliminarFormaPago:function(button){
      ...
      if (rec) {
             Ext.Ajax.request({
                 url :dinoaccess.util.Rutas.formaPagoEliminar,
                 params:{
    ...
    onClickEliminarModoEntrega:function(button){
      var rec = button.getWidgetRecord();
        if (rec) {
             Ext.Ajax.request({
                 url :dinoaccess.util.Rutas.modoEntregaEliminar,
                 params:{
    ...
    onClickEliminarMarca:function(btn){
        me = this;
        Ext.Ajax.request({
                url: dinoaccess.util.Rutas.marcaEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
    ...
    onClickEliminarModelo:function(btn){
        me = this;
        Ext.Ajax.request({
                url: dinoaccess.util.Rutas.modeloEliminar,
                params: { id          : btn.getWidgetRecord().get('id')},
                success: function(response){
                    var _error = Ext.JSON.decode(response.responseText);
                    if(_error.error!=0){
