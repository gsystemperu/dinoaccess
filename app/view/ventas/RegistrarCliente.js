Ext.define('dinoaccess.view.ventas.RegistrarCliente', {
    ...
    initComponent: function() {
        var storeTipoDoc = Ext.create('dinoaccess.store.TipoDocumentos');
        me = this;
        Ext.apply(me, {
            items: [
                {
                    ...
                    url : dinoaccess.util.Rutas.clienteGuardar,
                    bodyPadding: 5,
                    layout: {
                        type: 'hbox',
                        align: 'stretch'
                    ...
                    items: [
                        {
                            ...
                            itemId: 'btnCancelar',
                            scale : 'medium',
                            glyph: dinoaccess.util.Glyphs.getGlyph('cancelar'),
