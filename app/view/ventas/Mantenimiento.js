Ext.define('dinoaccess.view.ventas.Mantenimiento', {
    ...
    requires: [
        ...
        'Ext.toolbar.Toolbar',
        'Ext.form.Panel',
        'dinoaccess.view.ventas.AccionesMantenimiento'
    ],
    autoShow: true,
    width: 900,
    height: 400,
    ...
    getItems: function () {
        var storeUM = Ext.create('dinoaccess.store.UnidadMedida');
        var storeME = Ext.create('dinoaccess.store.ModoEntrega');
        var storeFP = Ext.create('dinoaccess.store.FormaPago');
        var storeVE = Ext.create('dinoaccess.store.Vendedores');
        var storePR = Ext.create('dinoaccess.store.Presentacion');
        var storeCA = Ext.create('dinoaccess.store.Categoria');
        ...
        var _obj = [{
            ...
            items: [{
                ...
                },
                {
                    ...
                    items: [{
                            xtype: 'form',
                            url: dinoaccess.util.Rutas.vendedorGuardar,
