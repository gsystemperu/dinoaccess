Ext.define('dinoaccess.view.ventas.GuiaRemision', {
    ...
    requires: [
        ...
        'dinoaccess.view.ventas.AccionesGuiaRemision'
    ],
    ...
    initComponent: function () {
        me = this;
        __storeGuiaRemisionDetalle = Ext.create('dinoaccess.store.GuiaRemisionDetalle');
        __storeMotivosTranslado    = Ext.create('dinoaccess.store.MotivosTranslados');
        Ext.applyIf(me, {
            items: [
            {
                    xtype: "form",
                    ...
                    url: dinoaccess.util.Rutas.guiaRemisionActualizar,
                    items: [
                      {
                          xtype:'panel',
                          border:false,
