Ext.define('dinoaccess.view.ventas.VisorVendedorCotizacion', {
    ...
    getItems: function () {
        var storeVendedor = Ext.create('dinoaccess.store.Vendedores');
        var storeEstadistica = Ext.create('dinoaccess.store.CotizacionesEstadisticaVendedor');
        var obj = [{
                xtype: 'container',
                flex: 0.8,
                layout: {
