Ext.define('dinoaccess.view.ventas.BuscarProductoFB', {
    extend: 'Ext.window.Window',
    alias: 'widget.wBuscarProductoFB',
    xtype: 'wBuscarProductoFB',
    requires: [
      'dinoaccess.view.ventas.AccionesRegFacturaBoleta'
    ],
    config : {
      cliente : 0,
      detalle : null
    ...
    initComponent: function () {
        var store = Ext.create('dinoaccess.store.ProductosPorPrecioPersona');
        me        = this;
