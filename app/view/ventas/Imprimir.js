Ext.define('dinoaccess.view.ventas.Imprimir', {
    ...
    getItems:function(){
      var storeOrientacion = Ext.create('dinoaccess.store.PosicionReporte');
      var storeFormato     = Ext.create('dinoaccess.store.FormatoReporte');
      var storeFirmas     = Ext.create('dinoaccess.store.Firmas');
