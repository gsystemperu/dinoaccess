Ext.define('dinoaccess.view.mrp.FormListaMaterial', {
    ...
    requires   : [
        ...
        'dinoaccess.view.mrp.AccionesFormListaMaterial',
    ...
    initComponent: function() {
        ...
        var storeProducto     = Ext.create('dinoaccess.store.Productos');
        //storeProducto.load();
    ...
    getFormularioProducto: function (storeUnidadMedida, storeProveedores,storeProducto) {
      _storeDetListaMateriales = Ext.create('dinoaccess.store.DetListaMateriales', {});
      storeProducto.load();
      var obj = [
        {
          xtype:'hiddenfield',
