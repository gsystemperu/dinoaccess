Ext.define('dinoaccess.view.almacen.IngresarAbastecimiento', {
    extend: 'Ext.window.Window',
    xtype: 'wingresarabastecimiento',
    requires: [
        'Ext.grid.plugin.*',
        'dinoaccess.view.almacen.AccionesReglasAbastecimiento',
    ...
    initComponent: function () {
        ...
        var storeTipoDoc      = Ext.create('dinoaccess.store.TipoDocumento');
        var storeProveedores = Ext.create('dinoaccess.store.Proveedores');
        var storeDetalle      = Ext.create('dinoaccess.store.DetalleAbastecimiento');
        me = this;
        Ext.applyIf(me, {
            items: [{
                    xtype: "form",
                    ...
                    url: dinoaccess.util.Rutas.abastecimientoGuardar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
