...
Ext.define('dinoaccess.view.almacen.ProductoUbicacion', {
    extend: 'Ext.window.Window',
    xtype:'wProductoUbicacion',
    requires:['dinoaccess.view.almacen.AccionesUbicacion'],
    modal:true,
    ...
    getItems:function(codigoserie){
      storeA = Ext.create('dinoaccess.store.Almacenes');
      storeS = Ext.create('dinoaccess.store.AlmacenSecciones');
      return obj = [
        {
            xtype: 'container',
            scrollable: true,
