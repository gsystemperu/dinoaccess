...
Ext.define('dinoaccess.view.almacen.AccionesReglasAbastecimiento', {
    ...
    onClickIngresar:function(){
        Ext.create('dinoaccess.view.almacen.IngresarAbastecimiento');
    },
    onClickBuscarProducto:function(btn){
        Ext.create('dinoaccess.view.almacen.ProductoBuscar');
    },
    ...
    onClickFormularioProveedor :function(btn){
        var win   = Ext.create('dinoaccess.view.almacen.FormProveedor',{control: btn.control.toString()});
    },
