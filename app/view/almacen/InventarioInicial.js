    ...
    Ext.define('dinoaccess.view.almacen.InventarioInicial', {
        ...
        requires: [
          ...
          'dinoaccess.view.almacen.InventarioInicialController',
          'Ext.grid.*',
          'Ext.form.field.*',
          'Ext.grid.plugin.*'
        ],
        ...
        url :  dinoaccess.util.Rutas.inventarioAgregar,
        controller: 'almacen-inventarioinicial',
        initComponent: function () {
          var st = Ext.create('dinoaccess.store.ProductoInventarioLista');
