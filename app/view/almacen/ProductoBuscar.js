Ext.define('dinoaccess.view.almacen.ProductoBuscar', {
    ...
    initComponent:function(){
        me = this;
        storeProducto  = Ext.create('dinoaccess.store.Productos');
        storeTipoProd  = Ext.create('dinoaccess.store.TipoDeProductos');
        Ext.apply(me,{
            items:[
