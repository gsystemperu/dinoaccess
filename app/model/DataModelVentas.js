Ext.define('dinoaccess.model.DataModelVentas', {extend: 'Ext.data.Model',fields: [{ name: 'id', type: 'int' }]});

// @Model : Producto
Ext.define('dinoaccess.model.ProductoPorCliente', {
...
// @Model : Cliente
Ext.define('dinoaccess.model.Cliente', {
    extend: 'Ext.data.Model',
    fields: [
        { name: 'idper', type: 'int' },
...
Ext.define('dinoaccess.model.TipoDocumento', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('dinoaccess.model.TipoDocumentoVenta', {
    extend: 'Ext.data.Model',
    fields: [
        { name: 'id', type: 'int' },
        { name: 'descripcion', type: 'string' },
...
Ext.define('dinoaccess.model.Cotizacion', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('dinoaccess.model.CotizacionDetalle', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('dinoaccess.model.FormaPago', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('dinoaccess.model.ModoEntrega', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('dinoaccess.model.Vendedor', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('dinoaccess.model.UnidadMedida', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('dinoaccess.model.Presentacion', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('dinoaccess.model.EstProducto', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('dinoaccess.model.CotizacionesFacturar', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('dinoaccess.model.DetFacturacion', {
    extend: 'Ext.data.Model',
    fields: [
...
Ext.define('dinoaccess.model.DetalleIngresoGuiaVista', {
    extend: 'Ext.data.Model',
    fields: [
...
// @Model Detalle de ingreso al almacen , muestra todos los ingresos de una orden de compra
Ext.define('dinoaccess.model.MotivoTranslado', {
    extend: 'Ext.data.Model',
    fields: [
      {name: "id", type:'int' },
      {name: "descripcion", type:'string' },
